...
INTERFACE_DECL(_EFI_ADAPTER_INFORMATION_PROTOCOL);

typedef
EFI_STATUS
(EFIAPI *EFI_ADAPTER_INFO_GET_INFO) (
  IN struct _EFI_ADAPTER_INFORMATION_PROTOCOL	*This,
  IN EFI_GUID					*InformationType,
...
#define EFI_ADAPTER_INFO_MEDIA_TYPE_ETHERNET 1
#define EFI_ADAPTER_INFO_MEDIA_TYPE_WIFI 2
